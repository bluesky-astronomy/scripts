...
MODERATORS = {
    ...
    "did:plc:curm4ncx66fzzygplesli77a": 2,  # jamiezvirzdin.com (Jamie)
    "did:plc:3wghkixdyfxcdqjw6bpnsn6b": 2,  # noelstoj.bsky.social (Jake N)
    "did:plc:uzecijkzuq4b7yjiwdg4b52i": 2,  # jakepost.tech (Jake P)
    "did:plc:54qsxdbgcjs47qqm7phoapyn": 2,  # epsori.bsky.social (Jerry)
